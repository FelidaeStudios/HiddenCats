...
public class GameManager : MonoBehaviour
{
    ...
    {
        var hidden = Array.FindAll(currentData.allObjects, obj => !obj.isFound);
        var found = Array.FindAll(currentData.allObjects, obj => obj.isFound);

        // Pass info to UI
        countText.text = found.Length + " / " + currentData.allObjects.Length;
    }
